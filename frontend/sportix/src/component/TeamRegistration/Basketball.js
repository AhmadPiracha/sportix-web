    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await axios(
                'http://localhost:8001/getBasketball',
        ...
        {Team.length >= 0 &&
            <Container maxWidth="lg" sx={{ mt: "40px" }}>
                <Stack direction="row" justifyContent="space-between">
                    <Typography variant="h5" color="#fff"><b>Basketball</b></Typography>
                    <Link to="/BasketballReg" style={{ textDecoration: "none" }}><Button variant="contained"><AddIcon />Add Teams</Button></Link>
                </Stack><br />
