...
import Logo from "../images/mint.jpg"
        ...
        <Card sx={{ width: 480 }}>
          <CardContent>
            <Stack direction="column" spacing={1}>
              <img src={Logo} />
              <Typography variant='h6' textAlign="start" fontFamily="Shadows Into Light"><b>Badminton Team Registration</b></Typography>
