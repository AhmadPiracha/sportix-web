            ...
            {cric.length >= 0 &&
                <Container maxWidth="lg" sx={{ mt: "40px" }}>
                    <Stack direction="row" justifyContent="space-between">
                        <Typography variant="h5" color="#fff"><b>Vollyball</b></Typography>
                        <Link to="/VollyballReg" style={{ textDecoration: "none" }}><Button variant="contained"><AddIcon />Add Teams</Button></Link>
                    </Stack><br />
