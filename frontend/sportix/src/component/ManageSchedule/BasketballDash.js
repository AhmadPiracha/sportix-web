    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await axios(
                'http://localhost:8001/getBasketballSchedule',
            ...
            {cric.length >= 0 &&
                <Container maxWidth="lg" sx={{ mt: "40px" }}>
                    <Stack direction="row" justifyContent="space-between">
                        <Typography variant="h5" color="#fff"><b>BasketBall Schedule</b></Typography>
                        <Link to="/BasketballSchedule" style={{ textDecoration: "none" }}><Button variant="contained"><AddIcon />Add Schedule</Button></Link>
                    </Stack><br />
